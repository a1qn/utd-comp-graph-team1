  ...
  public void StopCar()
{
    ...
    frontLeftCollider.brakeTorque = brakeForce * 10;
    frontRightCollider.brakeTorque = brakeForce * 10;
    rearLeftCollider.brakeTorque = brakeForce * 10;
    rearRightCollider.brakeTorque = brakeForce * 10;
}
